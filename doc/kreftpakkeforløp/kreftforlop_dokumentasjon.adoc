...
|A01::Brystkreft 
|I::Start pakkeforløp - første helseforetak
|<ingen>
...
WARNING: `I` koden over benyttes av DIPS Arena for å kode når pakkeforløpet faktisk startet i det første helseforetaket. Denne kan avvike fra når pakkeforløpet startet i eget helseforetak. 
